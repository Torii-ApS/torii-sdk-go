...
func (r ApiBanUserRequest) Execute() (*ServerUserResponse, *http.Response, error) {
...
func (a *ServerUsersAPIService) BanUserExecute(r ApiBanUserRequest) (*ServerUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ServerUserResponse
	)
...
func (r ApiCreateUserRequest) Execute() (*ServerUserResponse, *http.Response, error) {
...
//
//	@return ServerUserResponse
func (a *ServerUsersAPIService) CreateUserExecute(r ApiCreateUserRequest) (*ServerUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetUserRequest) Execute() (*ServerUserResponse, *http.Response, error) {
...
//
//	@return ServerUserResponse
func (a *ServerUsersAPIService) GetUserExecute(r ApiGetUserRequest) (*ServerUserResponse, *http.Response, error) {
	var (
...
func (r ApiListUserOrganizationsRequest) Cursor(cursor string) ApiListUserOrganizationsRequest {
	r.cursor = &cursor
	return r
}

func (r ApiListUserOrganizationsRequest) Execute() (*CursorPageResponseServerUserOrganizationResponse, *http.Response, error) {
	return r.ApiService.ListUserOrganizationsExecute(r)
}

/*
ListUserOrganizations List a user's organizations
...
*/
func (a *ServerUsersAPIService) ListUserOrganizations(ctx context.Context, userId string) ApiListUserOrganizationsRequest {
	return ApiListUserOrganizationsRequest{
		ApiService: a,
		ctx:        ctx,
		userId:     userId,
...
func (a *ServerUsersAPIService) ListUserOrganizationsExecute(r ApiListUserOrganizationsRequest) (*CursorPageResponseServerUserOrganizationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CursorPageResponseServerUserOrganizationResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerUsersAPIService.ListUserOrganizations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/server/v1/users/{userId}/organizations"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
...
func (r ApiSearchUsersRequest) Execute() (*CursorPageResponseServerUserResponse, *http.Response, error) {
...
func (a *ServerUsersAPIService) SearchUsersExecute(r ApiSearchUsersRequest) (*CursorPageResponseServerUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CursorPageResponseServerUserResponse
	)
...
func (r ApiUnbanUserRequest) Execute() (*ServerUserResponse, *http.Response, error) {
...
//
//	@return ServerUserResponse
func (a *ServerUsersAPIService) UnbanUserExecute(r ApiUnbanUserRequest) (*ServerUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateUserRequest) Execute() (*ServerUserResponse, *http.Response, error) {
...
//
//	@return ServerUserResponse
func (a *ServerUsersAPIService) UpdateUserExecute(r ApiUpdateUserRequest) (*ServerUserResponse, *http.Response, error) {
	var (
...
type ApiUpdateUserMetadataRequest struct {
	ctx                       context.Context
	ApiService                *ServerUsersAPIService
	userId                    string
...
func (r ApiUpdateUserMetadataRequest) UpdateUserMetadataRequest(updateUserMetadataRequest UpdateUserMetadataRequest) ApiUpdateUserMetadataRequest {
	r.updateUserMetadataRequest = &updateUserMetadataRequest
	return r
}

func (r ApiUpdateUserMetadataRequest) Execute() (*ServerUserResponse, *http.Response, error) {
	return r.ApiService.UpdateUserMetadataExecute(r)
}
...
*/
func (a *ServerUsersAPIService) UpdateUserMetadata(ctx context.Context, userId string) ApiUpdateUserMetadataRequest {
	return ApiUpdateUserMetadataRequest{
		ApiService: a,
		ctx:        ctx,
		userId:     userId,
...
//
//	@return ServerUserResponse
func (a *ServerUsersAPIService) UpdateUserMetadataExecute(r ApiUpdateUserMetadataRequest) (*ServerUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerUsersAPIService.UpdateUserMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/server/v1/users/{userId}/metadata"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateUserMetadataRequest == nil {
		return localVarReturnValue, nil, reportError("updateUserMetadataRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateUserMetadataRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
